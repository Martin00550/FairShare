...
const InvoicePDF = ({ expenses, userName }: { expenses: Expense[]; userName: string }) => (
    <Document>
        <Page size="A4" style={pdfStyles.page}>
            <View style={pdfStyles.header}>
                ...
                <View>
                    ...
                    <Text style={pdfStyles.invoiceDate}>{new Date().toLocaleDateString()}</Text>
                </View>
            </View>
            ...
            <View style={pdfStyles.totalSection}>
                <Text style={pdfStyles.totalLabel}>TOTAL REIMBURSEMENT DUE</Text>
                <Text style={pdfStyles.totalAmount}>${expenses.reduce((sum, e) => sum + Number(e.split_amount), 0).toFixed(2)}</Text>
            </View>
            <Text style={pdfStyles.footer}>Generated by FairShare • Professional Co-Parenting Finance Tool • {new Date().toLocaleDateString()}</Text>
        </Page>
    </Document>
);
...
export default function NewInvoicePage() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const blob = await pdf(<InvoicePDF expenses={selectedExpenses} userName={user?.firstName || "User"} />).toBlob();
            ...
            await fetch("/api/expenses/mark-invoiced", {
                method: "POST",
